import { Colors, convertToReadableDateTime } from '@/constants/Colors';
...
export const BookingCard = ({ item }: any) => {
...
{/* <ThemedText style={{ color: '#fff', fontSize: 10, fontWeight: 'bold' }}>
          ...
          <View style={{flexDirection:'row', justifyContent:'space-between'}}>
            ...
            {item.help_status !== 'N' &&
              <TouchableOpacity style={{alignContent:'flex-end'}} onPress={() => [openPopup(), setFormData({id: item.id, assigned_helper: item.assigned_helper})]}>
