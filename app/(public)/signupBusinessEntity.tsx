...
import { validateSignupBusinessEntity } from '@/components/validateSignupBusinessEntity'
import { Colors, encryptData } from '@/constants/Colors'
import { useAuth } from '@/hooks/AuthContext'
import { authenticateSignUpBusniessEntity, termsandconditons } from '@/hooks/AuthRoutes'
...
export default function signupBusinessEntity({
    ...
    const handleSignup = () => {
        const validationErrors = validateSignupBusinessEntity(formData);
