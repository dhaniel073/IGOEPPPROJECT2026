...
import { categoriesbylga } from '@/hooks/AuthRoutes';
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <>
            ...
            <TextInput style={styles.input} placeholder="Search categories by name" value={searchQuery} onChangeText={setSearchQuery} returnKeyType="search" /> 
