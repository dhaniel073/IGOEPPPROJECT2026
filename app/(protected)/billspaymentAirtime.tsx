...
import { Animated, Dimensions, Image, KeyboardAvoidingView, Modal, Platform, ScrollView, StyleSheet, Text, TextInput, TextProps, TouchableOpacity, View } from 'react-native'
    ...
    <SafeAreaView style={{ flex: 1, paddingHorizontal:20, paddingTop:10, backgroundColor: color1 }} edges={['top']}>
      ...
      >
        ...
        <FullScreenModal
          ...
          subText={`Your airtime recharge of ${amount} was successful`}
        />
      </KeyboardAvoidingView>
    </SafeAreaView>
  )
