      ...
      <Animated.ScrollView showsVerticalScrollIndicator={false}>
...

        {
          !data.photo ?
            ...
            :
            <Image style={[styles.image,]} source={{ uri: `${PUBLIC_API_BASE_URL}handyman/${data.photo}` }} />
        }
        ...
        <ThemedButton style={{ backgroundColor: Colors.green, padding: 15, borderRadius: 30, alignItems: 'center' }} onPress={() => {
          router.push({
            pathname: "/requesthelp", params: {
