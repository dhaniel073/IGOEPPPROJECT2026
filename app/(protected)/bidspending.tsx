...
import { bidaccept, bidacceptcash, bidacceptdebitcard, bidacceptinvoice, biddecline, bidnegotiate, bidrequests, getbanks, getsession, PUBLIC_API_BASE_URL, validatepin } from '@/hooks/AuthRoutes';
import { useThemeColor } from '@/hooks/useThemeColor';
import { Entypo, Feather, FontAwesome, FontAwesome5, FontAwesome6, Fontisto, MaterialCommunityIcons, MaterialIcons, SimpleLineIcons } from '@expo/vector-icons';
...
const dataBusiness = [
    ...
    },
    {
        id: "I",
        name: 'Pay as Invoice',
        icon: <MaterialCommunityIcons name="invoice" size={14} color={Colors.wallet} />
        ...
        <SafeAreaView style={{ flex: 1, paddingHorizontal: 20, paddingTop: 10, backgroundColor: color1 }} edges={['top', 'bottom']}>
                                    ...
                                    <View>
                                        {
                                            !item.photo ?
                                                ...
                                                :
                                                <Image
                                                    source={{ uri: `${PUBLIC_API_BASE_URL}handyman/${item.photo}` }}
                                                    style={styles.sman}
                                                />
                                        }
                                    </View>
            ...
            >
                ...
                >
                    ...
                    <Animated.View
                        style={[
                            styles.popup,
                            { transform: [{ translateY: slideAnim }], backgroundColor: color1, paddingBottom: "2%" },
                        ]}
                    >
            ...
            >
                ...
                >
                    ...
                    {
                        availbank &&
                        <ThemedButton style={{ backgroundColor: Colors.green, padding: 15, borderRadius: 30, alignItems: 'center' }} onPress={() => [closePopup3(), router.push({ pathname: "/(protected)/virtualaccountrequest", params: { amount: amount1, bidid: bidid, bank: availbank } })]}>
