...
import { customerinfocheck, customeruploadAddressproof, customeruploadIdcard } from '@/hooks/AuthRoutes'
  ...
  return (
    ...
    >
        <Animated.ScrollView showsVerticalScrollIndicator={false}>
            ...
            <TouchableOpacity style={{padding:20, flexDirection:'row', justifyContent:'space-between', alignItems:'center', backgroundColor: Colors.gray8, borderRadius:7}}>
                <View>
