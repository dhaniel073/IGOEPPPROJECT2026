...
import { Alert, FlatList, Image, ImageBackground, StyleSheet, TextProps, TouchableOpacity, View } from 'react-native'
                        ...
                        ListFooterComponent={
                            <>
                            {
                                ...
                                <>
                                    ...
                                    <View style={{margin:3}}/>
                                    <ThemedView style={[{padding:15, borderRadius:3, borderWidth:1, borderColor: Colors.gray10}]}>
                                        <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center',}}>
                                            <View style={{flexDirection:'row'}}>
                                                <View style={{ backgroundColor: Colors.wallet, padding: 10,borderRadius: 50}}>
                                                    <MaterialCommunityIcons name="wallet-plus" size={24} color="#fff" />
                                                </View>
                                                <View style={{marginLeft:10}}>
                                                    <ThemedText>Pay with Wallet</ThemedText>
                                            ...
                                            {data.map((item: any, key: any) => 
                                                <View key={key}>
                                                    <TouchableOpacity style={{padding: 15, borderRadius:10, flexDirection:'row', justifyContent:'space-between'}} onPress={() => [setavail(item)]}>
                                                        <TouchableOpacity style={[styles.outer, {borderColor: color}]} onPress={() => setavail(item)}>
                                    ...
                                    <ThemedButton enabled={true} style={{backgroundColor: Colors.green, padding: 15, borderRadius:30, alignItems:'center'}} onPress={() => setVisible(true)}>
